      ...
      <div className="col-12">
        ...
        <div className="course-buy-sidebar">
          <div className="side-bar ant-card-bordered">
            ...
            >
              <Menu.Item key="all-course">
                <a data-cate="" onClick={handleChangeCate}>
                  All Course
                </a>
              </Menu.Item>
              {dataCategory?.map((menu, index) => {
                if (menu.CourseType != "sub-menu") {
                  return (
                    <Menu.Item key={menu.CourseKey}>
                      <a data-cate={menu.CourseID} onClick={handleChangeCate}>
                        {menu.CourseTitle}
                      </a>
                    </Menu.Item>
                  );
                  ...
                  return (
                    <SubMenu key={menu.CourseKey} title={menu.CourseTitle}>
