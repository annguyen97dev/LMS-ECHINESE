				...
				<>
					<ul className="info-list">
						...
						<li>
							...
							<span className="text">{moment(userInformation?.DOB).format('DD/MM/YYYY')}</span>
						</li>
						<li>
		...
		<div className="package-set doing-test-box">
			...
			<div className="wrap-set">
				...
				<div className="wrap-set-content">
					...
					<p className="set-des">This is your first test in course, please be carefull on your all respon</p>
				</div>
			</div>
		</div>
	);
