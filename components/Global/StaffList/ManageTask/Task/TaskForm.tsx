						...
						<div className="row">
							<div
								className={`col-12 list-subtask ${
									isLoading.type === 'FETCH_TASK' && isLoading.status ? 'list-subtask-wrap' : ''
								}`}
							>
											...
											>
												<div className="info">
													...
													<span className="info-item">
														{item.DoneTask && item.StaffID ? 'Hoàn thành' : 'Phụ trách'}:{' '}
																...
																<Tooltip title="Cập nhật công việc">
																	...
																	>
																		<i
																			...
																			style={{ color: '#34c4a4', fontSize: 16 }}
																		></i>
																	</button>
																</Tooltip>
															) : (
						...
						<div className="row ">
							<div className="col-12">
								...
								>
									...
									{((isLoading.type === 'ADD_DATA' && isLoading.status) ||
										(isLoading.type === 'FETCH_TASK' && isLoading.status)) && <Spin className="loading-base" />}
								</button>
							</div>
						</div>
					</Form>
