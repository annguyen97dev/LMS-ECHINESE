...
const AddPromotion = ({ visible, onCancel }) => {
	...
	return (
		<Modal title="Mã khuyến mãi" visible={visible} onCancel={onCancel} footer={null}>
						...
						<div className="col-6">
							<Form.Item label="Phần trăm">
								<div className="row">
									{percent ? (
										<div className="col-9">
											<Input placeholder="Nhập phần trăm ..." defaultValue="25" />
										</div>
									) : (
										<div className="col-9">
											<Input placeholder="Nhập phần trăm ..." defaultValue="25" disabled />
										</div>
									)}
