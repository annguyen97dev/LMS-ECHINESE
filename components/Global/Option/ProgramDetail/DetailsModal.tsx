...
export const DetailsModal = (props) => {
  ...
  return (
    <>
      ...
      <Modal
        title="Thông tin chương trình dạy"
        visible={visible}
              ...
              <div className="p-4 details">
                {data.length !== 0 ? (
                  <div>
                    ...
                    <div className="row m-0">
                      {!enableEdit ? (
                        ...
                        <Form.Item className="mr-3">
                          ...
                          >
                            <Button
                              className="item-info item-info__Upload"
                              icon={<UploadOutlined />}
                            >
                    ...
                    <Form.Item>
                      <p style={{ color: !enableEdit ? "#bebebe" : "#000" }}>
                        Ghi chú
                      </p>
                      <TextArea
                        rows={4}
                    ...
                    <Input
                      ...
                      value={
                        ...
                        selected.SecondVideo === undefined
                          ? "Không rõ"
                          : selected.SecondVideo
                      }
                      disabled
                    ...
                    {!enableEdit ? (
                      ...
                      <Tooltip title="Lưu thông tin">
                        <button
                          ...
                          className="btn ml-3 mt-2 btn-success"
                        >
