            ...
            <div className="row">
                ...
                <div className="col-6">
                    <Form.Item
                        label="Số kỹ năng"
                        name="Số kỹ năng"
                        initialValue={props.rowData?.Skills}
                    >
                        <InputNumber
            ...
            <div className="row">
                ...
                <div className="col-6">
                    <Form.Item
                        label="Speaking"
                        name="Speaking"
                        initialValue={props.rowData?.SpeakingPoint}
                    >
                        <InputNumber
                            className="ant-input w-100 style-input"
            ...
            <div className="row">
                <div className="col-6">
                    <Form.Item
                        label="Reading"
                        name="Reading"
                        initialValue={props.rowData?.ReadingPoint}
                    >
                        <InputNumber 
                            className="ant-input w-100 style-input"
                ...
                <div className="col-6">
                    <Form.Item
                        label="Writing"
                        name="Writing"
                        initialValue={props.rowData?.WritingPoint}
                    >
                        <InputNumber
                            className="ant-input w-100 style-input"
